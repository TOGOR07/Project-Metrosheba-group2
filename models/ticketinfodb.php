...
function getTicketInfoStats()
{
    ...
    $q1 = "SELECT COUNT(*) as total_customers FROM users";
...
{
    global $conn;
    $sql = "SELECT id, username, from_station, to_station, quantity, per_price, total_price, purchase_date FROM metroshebatickets ORDER BY id DESC";
