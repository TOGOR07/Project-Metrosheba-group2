        ...
        <div class="table-container">
            ...
            <div class="table-card" style="margin-bottom:20px;">
                ...
                <form method="POST" action="../controllers/AdminDashboardController.php">
                    ...
                    <input class="form-input" type="text" name="name" value="<?php echo $editUser['name']; ?>" required>
                    <input class="form-input" type="email" name="email" value="<?php echo $editUser['email']; ?>" required>
                    <input class="form-input" type="text" name="mobile_number" value="<?php echo $editUser['mobile_number']; ?>" required>
                    <input class="form-input" type="text" name="nid" value="<?php echo $editUser['nid']; ?>" required>
